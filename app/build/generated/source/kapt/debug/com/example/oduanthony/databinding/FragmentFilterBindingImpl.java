...
public class FragmentFilterBindingImpl extends FragmentFilterBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.allFilter, 1);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.myFirstView == variableId) {
            setMyFirstView((com.example.oduanthony.screens.filter.FilterViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMyFirstView(@Nullable com.example.oduanthony.screens.filter.FilterViewModel MyFirstView) {
        this.mMyFirstView = MyFirstView;
    }
